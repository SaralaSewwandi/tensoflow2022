...
def main():
    '''
    Validation Data Set has to e prepared in the follwing structure
    Root Folder: image_net
    Inside the Root folder there should e folders with the class names
    Inside the class names folders images for the relavant class are stored
    ...
    clone the validation dataset from following url and remove the .git folder before running the script
    url : https://github.com/SaralaSewwandi/image_net_dataset
    command
    git clone https://github.com/SaralaSewwandi/image_net_dataset.git
