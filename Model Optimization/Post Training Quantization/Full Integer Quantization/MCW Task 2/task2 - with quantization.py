...
tflite_models_dir = pathlib.Path("/tmp/resnet_tflite_models/full_integer_quantization")
tflite_models_dir.mkdir(exist_ok=True, parents=True)

# Save the quantized model:
tflite_model_quant_file = tflite_models_dir/"resnet_model_quant_integer_only.tflite"
