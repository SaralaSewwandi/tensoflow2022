...
'''
Now all weights and variable data((such as model input/output and intermediates between layers) ) are quantized, a

nd the model is significantly smaller compared to the original TensorFlow Lite model.
...
'''
That's usually good for compatibility, 
...
tflite_model_quant_file = tflite_models_dir/"mnist_model_quant_float_fallback.tflite"
